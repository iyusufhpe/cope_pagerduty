...
'''
    Usage:
    python fetch-incidents.py --month 1 --year 2024  # Fetch data for January 2024
    python fetch-incidents.py --last_n_months 3  # Fetch data for the last three months from today
    python fetch-incidents.py --start_date 04/23/2024 --end_date 04/24/2024  # Fetch data for a specific date range
'''
